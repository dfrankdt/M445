function [x, t, w] = FTCS(nt)
% Goal: Use FTCS to approximate the solution to the test problem given in
...
for n=1:nt
    ...
    % FTCS matrix
    E_FTCS = (eye(N+1) - lambda*A - dt*B);
    
    % Step forward
    w(:, n+1) = E_FTCS*w(:, n) - lambda*b + dt*s;
end
